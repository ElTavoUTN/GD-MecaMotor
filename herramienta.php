...
<html lang="es">
    ...
    <body>
        ...
        <div class="jumbotron">
            ...
            <div class="container">
                <h1>MecaMotor</h1>
                <button class="btn btn-success btn-md" data-toggle="modal" data-target="#miventana" role="button">Agregar Herramienta</button>  
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal" method="post" action="agregaHerramienta.php">
                                    <div class="form-group">

                                        <label for="nombreH" class="col-lg-2 control-label">Nombre de Herramienta: </id></label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="nombreH" placeholder="Ingrese nombre de la herramienta" required autofocus  style="width:300px;"></input> <br>
                                        </div>                

                                        <label for="cantH" class="col-lg-2 control-label">Cantidad de herramienta:</id></label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="cantH" placeholder="Ingrese cantidad herramienta" required autofocus  style="width:300px;"></input><br>
                                        </div>  

                                        <label for="nroH" class="col-lg-2 control-label">Número de Herramienta: </id></label> 
                                        <div class="col-lg-10">  
                                            <input type="text" class="form-control" name="nroH" placeholder="Ingrese número de herramienta" required autofocus  style="width:300px;"></input> <br>
                                        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-bordered ">
                        ...
                        <tbody ><?php
                            ...
                            $tabla = mysql_query("SELECT * FROM herramienta");
                            while ($filaTabla = mysql_fetch_array($tabla)) {
                                ?> 

                                <tr>
                                    <td><?php echo $filaTabla['nombreHerramienta'] ?></td>
                                    <td><?php echo $filaTabla['cantHerramienta'] ?></td>
                                    <td><?php echo $filaTabla['nroHerramienta'] ?></td>
